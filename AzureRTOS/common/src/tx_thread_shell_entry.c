...
/* Retained diagnostic: confirms execution has reached a newly restored thread. */
extern volatile ULONG tx_diag_shell_stage;
...
VOID            (*entry_exit_notify)(TX_THREAD *notify_thread_ptr, UINT type);
    ...
    tx_diag_shell_stage = 1U;

    /* Perform any additional activities for tool or user purpose.  */
    TX_THREAD_STARTED_EXTENSION(thread_ptr)
    tx_diag_shell_stage = 2U;

#ifndef TX_DISABLE_NOTIFY_CALLBACKS

    /* Disable interrupts.  */
    TX_DISABLE
    tx_diag_shell_stage = 3U;
